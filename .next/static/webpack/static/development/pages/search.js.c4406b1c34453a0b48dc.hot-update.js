...
function () {
  ...
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(_ref2) {
    var ctx, _ctxquery, query, sort, lang, order, page, queryString, result;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ctx = _ref2.ctx;
            console.log(ctx);
            _ctxquery = ctxquery, query = _ctxquery.query, sort = _ctxquery.sort, lang = _ctxquery.lang, order = _ctxquery.order, page = _ctxquery.page;
...
//# sourceMappingURL=search.js.c4406b1c34453a0b48dc.hot-update.js.map